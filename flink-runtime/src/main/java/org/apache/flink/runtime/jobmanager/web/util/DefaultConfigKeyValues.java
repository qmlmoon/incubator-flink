...
public final class DefaultConfigKeyValues {
	...
	public static Set<String> INT_FIELD_KEYS = new HashSet<String>(Arrays.asList(
	...
	public static Set<String> LONG_FIELD_KEYS = new HashSet<String>(Arrays.asList(
		ConfigConstants.LIBRARY_CACHE_MANAGER_CLEANUP_INTERVAL,
		ConfigConstants.TASK_MANAGER_DEBUG_MEMORY_USAGE_LOG_INTERVAL_MS
	));

	public static Set<String> FLOAT_FIELD_KEYS = new HashSet<String>(Arrays.asList(
		ConfigConstants.TASK_MANAGER_MEMORY_FRACTION_KEY,
		ConfigConstants.DEFAULT_SORT_SPILLING_THRESHOLD_KEY,
		ConfigConstants.YARN_HEAP_CUTOFF_RATIO
	));

	public static Set<String> DOUBLE_FIELD_KEYS = new HashSet<String>(Arrays.asList(
		ConfigConstants.AKKA_WATCH_THRESHOLD,
		ConfigConstants.AKKA_WATCH_THRESHOLD
	));

	public static Set<String> BOOLEAN_FIELD_KEYS = new HashSet<String>(Arrays.asList(
